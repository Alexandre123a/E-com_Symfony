...
class CategorieControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'categorie[intitule]' => 'Testing',
            'categorie[idGenre]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'categorie[intitule]' => 'Something New',
            'categorie[idGenre]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getIdGenre());
    }
